	...
	:::::::::::::::::::::::::::::::::::::::::::--> 
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="<?php SERVERURL; ?>buscar-producto"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PRODUCTOS</a>
					</li>
				</ul>	
			</div>
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating" style="color: black">¿Qué producto estas buscando?</label>
