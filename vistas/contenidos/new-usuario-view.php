<!-- Page header -->
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="<?php SERVERURL; ?>new-usuario"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO USUARIO</a>
					</li>
					<li>
							...
							<div class="row">
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_ci" class="bmd-label-floating" style="color: black">CI</label>
										<input type="text" pattern="[0-9-]{1,20}" class="form-control" name="usuario_ci_reg" id="usuario_dni" maxlength="20">
									</div>
								</div>
								
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_nombre" class="bmd-label-floating" style="color: black">Nombres</label>
					...
					<fieldset>
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_usuario" class="bmd-label-floating" style="color: black">Nombre de usuario</label>
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_clave_1" class="bmd-label-floating" style="color: black">Contraseña</label>
										<input type="password" class="form-control" name="usuario_clave_1_reg" id="usuario_clave_1" maxlength="200">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_clave_2" class="bmd-label-floating" style="color: black">Repetir contraseña</label>
										<input type="password" class="form-control" name="usuario_clave_2_reg" id="usuario_clave_2" maxlength="200">
									</div>
								</div>
							</div>
						</div>
